...
const HeroSection = () => {
  ...
  return (
    <div className=''>
      ...
      <Link href="/docs/Resume light.pdf" className='mx-auto mt-10 w-fit  rounded-lg  bg-gradient-to-r from-[#000] to-[#0dc27c] hover:scale-105 border-2 py-1.5 sm:py-2.5 px-8 sm:px-14 border-[#0dc27c] text-white relative z-40 text-lg font-semibold transition-all block' target='_blank' download>Hire Now!</Link>
